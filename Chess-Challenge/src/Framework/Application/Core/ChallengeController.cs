	...
	public class ChallengeController
	{
		...
		ChessPlayer CreatePlayer(PlayerType type)
		{
			return type switch
			{
				...
				PlayerType.AtadOfANoobBot => new ChessPlayer(new AtadOfANoobBot(), type, GameDurationMilliseconds),
				PlayerType.P4kBotOld => new ChessPlayer(new P4kBotOld(), type, GameDurationMilliseconds),
		...
		public static ChessChallenge.API.IChessBot? CreateBot(PlayerType type)
		{
			return type switch
			{
				...
				PlayerType.AtadOfANoobBot => new AtadOfANoobBot(),
				PlayerType.P4kBotOld => new P4kBotOld(),
		...
		static (int totalTokenCount, int debugTokenCount) GetTokenCount()
		{
			...
			string path = Path.Combine(Directory.GetCurrentDirectory(), "src", "My Bot", "AtadOfANoobBot.cs");
