...
public class P4kBot : IChessBot
{
	...
	public Move Think(Board board, Timer timer)
	{
		var (psqts, history, depth) = (new[] {
			0x003c23120f0e0f00UL, 0x273b42403e3b3733UL, 0x333b3f3b3d3d3b35UL, 0x595a585653505051UL, 0xa7a7ada7a6a5a5a3UL, 0x7090706050201UL, 0xe151110100e110eUL, 0x292e333333312d26UL, 0x353a373838393833UL, 0x5054585a5b5a5855UL, 0xacacacababa9a7a3UL, 0x50c080806080700UL,
		}, new int[4096], 0);
